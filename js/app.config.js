...
'hola' : function() { alert("Que paso?... Dijiste 'Hola'"); },
'puto' : function() { alert("Tu eres el puto!..."); },
'puta' : function() { alert("Tu eres la puta!..."); },
'chinga tu madre' : function() { alert("La tuya pendej@!"); },
'gay' : function() { alert("Put@ Maricon! jajaja!"); },
'verga' : function() { alert("Pelas! jajaja!"); },

'mostrar productos' : function() { $('nav a[href="#_/productos"]').trigger("click"); },
'productos' : function() { $('nav a[href="#_/productos"]').trigger("click"); },
			...
			'help' : function() {
				$('#voiceModal').removeData('modal').modal( { remote: "../../tools/comandos_voz.php", show: true } );
				if ($('#speech-btn .popover').is(':visible')) {
					$('#speech-btn .popover').fadeOut(250);
				}
			},		
